...
const int LEFT_HIP_CENTRE = 1610; //1580 -> 1610
const int LEFT_HIP_MIN    = LEFT_HIP_CENTRE - 500;//500
const int LEFT_HIP_MAX    = LEFT_HIP_CENTRE + 500;//500

const int LEFT_FOOT_CENTRE = 1350;//1410 -> 1350
const int LEFT_FOOT_MIN    = LEFT_FOOT_CENTRE - 500;//500
const int LEFT_FOOT_MAX    = LEFT_FOOT_CENTRE + 500;//500

const int RIGHT_HIP_CENTRE = 1500;//1500
const int RIGHT_HIP_MIN    = RIGHT_HIP_CENTRE - 500;//500
const int RIGHT_HIP_MAX    = RIGHT_HIP_CENTRE + 500;//500

const int RIGHT_FOOT_CENTRE = 1465;//1465
const int RIGHT_FOOT_MIN    = RIGHT_FOOT_CENTRE - 500;//500
const int RIGHT_FOOT_MAX    = RIGHT_FOOT_CENTRE + 500;//500
...
const int FOOT_DELTA = 180; //150->280
const int HIP_DELTA  = FRONT_JOINT_HIPS * 150; //120->260
